...
public class MailUtils {
    ...
    public final static String apikey = "e2729b42f5122c1b2e2422c33ba8d913";
    final static String user = "vuducphuoc.pi@gmail.com";
    final static String pass = "Loveyou0205";
    ...
    public static void sendMail(String to,String sub,String content)  {
        try {
