...
public class DateUtil {
    ...
    public static String changeDate(String dateString, int days) throws ParseException {
    ...
    public static String castDateForm1ToForm2(String dateForm1) throws ParseException{
        DATE_FORMATER1.setLenient(false);
    ...
    public static String castDateForm3ToForm1(String dateForm3) throws ParseException{
        DATE_FORMATER1.setLenient(false);
