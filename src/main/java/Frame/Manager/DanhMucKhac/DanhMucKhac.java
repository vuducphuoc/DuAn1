...
public class DanhMucKhac extends JPanel {
    public static QuanLyPhongBan quanLyPhongBan = new QuanLyPhongBan();
    public static QuanLyNhaSanXuat quanLyNhaSanXuat = new QuanLyNhaSanXuat();
    public static QuanLyQuocGia quanLyQuocGia = new QuanLyQuocGia();
